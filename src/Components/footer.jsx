    ...
    <footer className='px-3 lg:px-7 py-8'>
      <div className=''>
        <div className='flex flex-col lg:items-center  space-y-8 lg:border border-solid border-[#333333] py-5'>
          ...
          <form className='space-y-8 lg:flex lg:space-x-5 items-center lg:space-y-0 ' onSubmit={submit}>
            <input
              type='email'
              value={email}
              autoComplete="Email"
              ...
              className='py-4 px-2 lg:pr-40 w-full border border-solid border-[#333333]  text-[#333333]  text-left'
            />
